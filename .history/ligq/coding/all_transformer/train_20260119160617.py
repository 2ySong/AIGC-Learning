...
# 伪造一个 batch 的输入 (Batch=4, Len=16)
input_batch = torch.randint(0, max_value_token-content_length, (batch_size,))

# 前向传播
output = model(input_batch)

print("输入形状:", input_batch.shape) 
# [4, 16]
print("输出形状:", output.shape)      
# [4, 16, 100277] <- 只有变成这个形状，才能去计算交叉熵损失
print("测试通过！")
